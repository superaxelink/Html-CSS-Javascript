...
export class UI{
  ...
  draw(context){
    context.save(); //to draw the shadow and that only affect the text
    context.shadowOffsetX = 2; // to draw shadows behind text
    ...
    context.fillText('Time: ' + (this.game.time * 0.001).toFixed(1), 20, 80); //timer
    // game over messages
