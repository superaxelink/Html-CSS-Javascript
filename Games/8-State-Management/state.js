//This will handle all the possible states of the player
export const states = {//stores possible states
  STANDING_LEFT: 0,
  STANDING_RIGHT: 1,
  SITTING_LEFT: 2,
  SITTING_RIGHT: 3,
...
export class StandingLeft extends State{
  ...
  enter(){ //this will do everything that needs to be done when player
//enters this particular state
    this.player.frameY = 1;
    this.player.speed = 0;
    this.player.maxFrame = 6;
  }
  handleInput(input){//to listen to a predefined set of inputs and swap
